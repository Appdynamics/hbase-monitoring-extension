...
public class MetricCheckIT {
    ...
    public void testAPICallsMetric() {
        ...
        if (metricAPIService != null) {
            jsonNode = metricAPIService.getMetricData("",
                    "Server%20&%20Infrastructure%20Monitoring/metric-data?metric-path=Application%20Infrastructure%20Performance%7CRoot%7CCustom%20Metrics%7CHBase%7CHeartBeat&time-range-type=BEFORE_NOW&duration-in-mins=60000&output=JSON");
        }
        ...
        Assert.assertTrue("HBase Metrics Uploaded", valueNode.get(0).asInt() > 0);
    ...
    public void checkDashboardsUploaded() {
        ...
        if (customDashboardAPIService != null) {
            ...
            dashboardPresent = IntegrationTestUtils.isDashboardPresent("Hbase Dashboard", allDashboardsNode);
